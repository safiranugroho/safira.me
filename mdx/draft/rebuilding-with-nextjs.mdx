...
- [ ] Doodles
  ...
  - [x] Tip calculator doodle has a bug (needs to round up to 2 decimal points)
  ...
  - [x] DRY the process of creating web components
  - [x] Position doodle is not working - styling is all off
  - [x] Doodle page layout
  - [x] Separate playground styling from shared doodle styling
  - [x] Figure out how to host the doodles in the new infra (Published as npm package)
  - [x] Fix broken elements that don't work with dark mode
  - [x] ~~Figure out Prismjs styles~~ Gave up, all code is the same color now.
  - [x] Doodles list
  - [x] "This doodle is only available on desktop. Sry."
  - [ ] Redirect doodles.safira.me to safira.me/doodles
  - [x] Position doodle's buttons in the info panel doesn't have styling?
  - [x] Filter doodle's reset all button needs to be clicked twice
  - [ ] Publish package via Netlify
- [x] Redirect old paths of blog posts to new paths
